...
-- at runtime using the environment variable pure_functions_bindir.
...
-- environment variable pure_functions_libdir.
...
-- using the environment variable pure_functions_dynlibdir.
...
-- runtime using the environment variable pure_functions_datadir.
...
-- variable pure_functions_libexedir.
...
-- using the environment variable pure_functions_sysconfdir.
...
bindir     = "/Users/isaia/.cabal/bin"
libdir     = "/Users/isaia/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf/pure-functions-0.1.0.0-inplace-pure-functions-test"
dynlibdir  = "/Users/isaia/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf"
datadir    = "/Users/isaia/.cabal/share/aarch64-osx-ghc-9.14.1-bcbf/pure-functions-0.1.0.0"
libexecdir = "/Users/isaia/.cabal/libexec/aarch64-osx-ghc-9.14.1-bcbf/pure-functions-0.1.0.0"
sysconfdir = "/Users/isaia/.cabal/etc"

getBinDir     = catchIO (getEnv "pure_functions_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "pure_functions_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "pure_functions_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "pure_functions_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "pure_functions_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "pure_functions_sysconfdir") (\_ -> return sysconfdir)
